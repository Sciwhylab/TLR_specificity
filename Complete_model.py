...
def uncharacterize_pred(nbdata, model):
...
if __name__=='__main__':
    ...
    nbdata = pd.read_csv(input_path2, skiprows=2, sep="\t")
    #print(nbdata)
    
    nbt_df = uncharacterize_pred(nbdata, model)
    nbt_df.to_csv(os.path.join(output_dir, "Novel_and_Blind_set_TLR_specificity_predictions.tsv"), sep="\t")
